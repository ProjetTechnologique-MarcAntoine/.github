# Projet Technologique (IoT)

## Fait par Marc-Antoine Lavoie

Projet API (Node.JS/Inclus les instructions pour mettre en place le VPS en entier): https://github.com/ProjetTechnologique-MarcAntoine/API-GarageDetector (**À faire en premier**) \
